# Generated by Django 5.0.6 on 2024-05-08 10:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Broker',
            fields=[
                ('broker_id', models.TextField(db_column='Broker ID', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch_id', models.ForeignKey(blank=True, db_column='Branch ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='base.branch')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='branch',
            name='broker_id',
            field=models.ForeignKey(blank=True, db_column='Broker ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='base.broker'),
        ),
        migrations.CreateModel(
            name='Build',
            fields=[
                ...
                ('strategist_name', models.ForeignKey(blank=True, db_column='Strategist Name', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='base.algobullsemployee')),
            ],
            options={
                'db_table': 'Build',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch_employee_id', models.ForeignKey(blank=True, db_column='Branch Employee ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='base.branchemployee')),
                ('division_employee', models.ForeignKey(blank=True, db_column='Division Employee', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='support_division_employee_set', to='base.algobullsemployee')),
                ('support_employee', models.ForeignKey(blank=True, db_column='Support Employee', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='base.algobullsemployee')),
            ],
            options={
                'db_table': 'Support',
                'managed': True,
